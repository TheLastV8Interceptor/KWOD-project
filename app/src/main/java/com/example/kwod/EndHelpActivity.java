...
public class EndHelpActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_end_help_activity);
        intent = getIntent();
        ...
        speechRecognizer.setRecognitionListener(new RecognitionListener() {
            ...
            public void onResults(Bundle bundle) {
                ...
                Log.d("EndHelpActivity", bestResult);
                if(bestResult.equals("Ponów") || bestResult.equals("PONÓW") || bestResult.equals("ponów"))
                {
                    switch_to_MainActivity(view);
                }
